...
v0.new("<Color=Cyan>Welcome nana cutte Đã Bị trọng béo lỏ open source <Color=/>"):Display();
wait(0.5);
...
v8.Image = "rbxassetid://98205229376191";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "nana tv hub ",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=98205229376191&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
